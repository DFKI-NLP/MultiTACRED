...
class DatasetConverter:
    def __init__(self, dataset_dir, output_dir):
        ...
        self.input_train_file = os.path.join(dataset_dir, "train.json")
        self.input_test_file = os.path.join(dataset_dir, "test.json")
        self.input_dev_file = os.path.join(dataset_dir, "dev.json")
...
def main(args):
    ...
    converter = DatasetConverter(args.dataset_dir, args.output_dir)
    converter.run()
